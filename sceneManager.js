class SceneManager {
    constructor(game) {
        ...
        this.game.addEntity(new WorldObject(this.game,path,-200,-200,true,2));
        this.game.addEntity(new WorldObject(this.game,"./assets/background/1 Tiles/Map_tile_01.png",-400,-200,true,2));
    };
